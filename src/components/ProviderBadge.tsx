              ...
              <div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    disabled
                    placeholder="AIzaSy..."
                    className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-900 focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-100 font-mono"
                  />
                </div>
              </div>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    {showValues ? (
                      <textarea
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-900 focus:outline-none focus:border-green-400 focus:ring-1 focus:ring-green-100 font-mono"
                      />
                    ) : (
                      <input
                        type="password"
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex flex-col gap-1 flex-1">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-900 focus:outline-none focus:border-green-400 focus:ring-1 focus:ring-green-100"
                      />
                    </div>
                  </div>
                </div>
