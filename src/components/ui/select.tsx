...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.GroupLabel
      ...
      className={cn(
        'px-1.5 py-1 type-level-3 text-muted-foreground',
        className
      )}
      {...props}
    />
